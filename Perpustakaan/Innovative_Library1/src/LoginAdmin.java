...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            sql = "SELECT *FROM loginadmin WHERE username= '"+AdminName.getText()+"'AND password= '"+AdminPassword.getText()+"'";
            rs = stat.executeQuery(sql);
            if(rs.next()){
                if(AdminName.getText().equals(rs.getString("username")) && AdminPassword.getText().equals(rs.getString("password"))){
